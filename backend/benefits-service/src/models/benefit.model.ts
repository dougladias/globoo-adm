...
// Criar modelos
export const BenefitType: Model<IBenefitType> = mongoose.models.BenefitType || model<IBenefitType>('BenefitType', BenefitTypeSchema);
export const EmployeeBenefit: Model<IEmployeeBenefit> = mongoose.models.EmployeeBenefit || model<IEmployeeBenefit>('EmployeeBenefit', EmployeeBenefitSchema);